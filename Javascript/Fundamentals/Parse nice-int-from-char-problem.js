...
/*
Approach:
1. Split the string by space and get the first element
2. Convert the first element to integer and return it

What I learned:
1. parseInt() function can be used to convert a string to integer
*/
